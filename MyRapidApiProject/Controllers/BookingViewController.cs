...
namespace MyRapidApiProject.Controllers
{
                ...
                Headers =
    {
        ...
        public async Task<IActionResult> BookingHotelSearch(string destId, string dateIn, string dateOut, int guest, int children)
        {
            ...
            {
                Method = HttpMethod.Get,
                RequestUri = new Uri($"https://booking-com15.p.rapidapi.com/api/v1/hotels/searchHotels?dest_id={destId}&search_type=CITY&arrival_date={dateIn}&departure_date={dateOut}&adults={guest}&children_age={children}&room_qty=1&page_number=1&units=metric&temperature_unit=c&languagecode=en-us&currency_code=USD"),
                Headers =
    {
        { "x-rapidapi-key", "68eb318446mshffd79b1cafbc963p11cf5djsncafe11ee2e5d" },
        { "x-rapidapi-host", "booking-com15.p.rapidapi.com" },
